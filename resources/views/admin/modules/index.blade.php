                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled nav nav-pills flex-column">
                            @foreach($filter['options'] as $option => $value)
                                <li class="nav-item">
                                    <a href="{{ route('admin.modules.index', currentFilter($filter, $option)) }}"
            ...
            <div class="row">
                @forelse($modules as $module)
                    <div class="col-sm-12 col-md-4">
                        <div class="card mb-4">
                            <div class="card-body">
                                <h3>{{ $module['name'] }} <span class="float-right"><a
                                            href="{{ route('admin.modules.show', $module['slug']) }}"><i
                                                class="fas fa-cogs"></i> </a></span></h3>
                                <p>{{ \Illuminate\Support\Str::limit($module['description'], 120) }}...</p>
                            </div>
                        </div>
                    </div>
                @empty
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="alert alert-info">
                                    ...
                                    @else
                                        It doesn't look like you have any modules yet
                                    @endif
                                </div>
                            </div>
                        </div>
